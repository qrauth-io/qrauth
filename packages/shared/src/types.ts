...
// ---------------------------------------------------------------------------
// Authenticated user (shape returned by GET /auth/me, consumed by the web app)
// ---------------------------------------------------------------------------
...
/**
 * The authenticated user as returned by `GET /auth/me` and held in the web
 * auth context. JSON-serialised over the wire, so `onboardedAt` is an ISO
 * string (or null until the user finishes onboarding).
 */
