...
export const DeviceTrustLevel = {
  NEW: 'NEW',
  TRUSTED: 'TRUSTED',
  SUSPICIOUS: 'SUSPICIOUS',
  REVOKED: 'REVOKED',
} as const;
export type DeviceTrustLevel = (typeof DeviceTrustLevel)[keyof typeof DeviceTrustLevel];

// ---------------------------------------------------------------------------
// Ephemeral sessions
// ---------------------------------------------------------------------------

export const EphemeralSessionStatus = {
  PENDING: 'PENDING',
  CLAIMED: 'CLAIMED',
  EXPIRED: 'EXPIRED',
  REVOKED: 'REVOKED',
} as const;
export type EphemeralSessionStatus = (typeof EphemeralSessionStatus)[keyof typeof EphemeralSessionStatus];

/** Default TTL for ephemeral sessions in seconds (30 minutes). */
export const EPHEMERAL_SESSION_DEFAULT_TTL = 1800;

/** Maximum TTL for ephemeral sessions in seconds (72 hours). */
export const EPHEMERAL_SESSION_MAX_TTL = 259200;

/** Maximum number of uses for a multi-use ephemeral session. */
export const EPHEMERAL_SESSION_MAX_USES = 1000;

/** TTL for WebAuthn challenges in seconds. */
export const WEBAUTHN_CHALLENGE_TTL = 300; // 5 minutes
