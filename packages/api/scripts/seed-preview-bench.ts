 ...
 *     supplies. `__test_signPayload` applies the canonical domain
 *     prefix internally (#62 62b) so callers no longer prepend.
...
async function signCanonicalForSeed(args: {
  ...
  return signPayload(args.privateKeyPem, args.canonical);
}
