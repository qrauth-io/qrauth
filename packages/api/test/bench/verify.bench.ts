...
// __test_signPayload_raw on purpose: the bench's verify side calls
// verifySignature directly against the raw canonical (no prefix), so the
// signing side must also skip the prefix to keep the round-trip
// internally consistent. The bench measures the cost of the verify
// pipeline; whether the signature was prefixed or not doesn't change
// the work being measured.
import {
  __test_signPayload_raw as signPayload,
  verifySignature,
