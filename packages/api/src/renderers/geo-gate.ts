...
<head>
  ...
  <style nonce="${nonce}">
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    .deny-card h1 { color: #B45309; }
    .footer {
      margin-top: 20px;
      font-size: 11px;
      color: rgba(10, 10, 10, 0.25);
    }
    .footer a { color: rgba(10, 10, 10, 0.4); text-decoration: none; }
    .token {
      margin-top: 6px;
...
<body>
  <div class="card" id="gate-card">
    <div class="pin">
      <svg width="36" height="36" viewBox="0 0 24 24" fill="none" stroke="#4F46E5" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
  ...
  <div class="card deny-card" id="deny-card">
    <div class="pin">
      <svg width="36" height="36" viewBox="0 0 24 24" fill="none" stroke="#B45309" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
        <path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 1 1 18 0z"/>
...
<body>
  <div class="card">
    <div class="pin">
      <svg width="36" height="36" viewBox="0 0 24 24" fill="none" stroke="#E11D48" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
