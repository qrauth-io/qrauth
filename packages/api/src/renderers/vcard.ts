...
function renderVCardContent(ctx: RenderContext): string {
  ...
  return `
    <style>
      ...
      .vcard-photo-placeholder { width: 96px; height: 96px; border-radius: 50%; margin: 0 auto 12px; display: flex; align-items: center; justify-content: center; background: #EEF2FF; color: #4F46E5; font-size: 36px; font-weight: 700; }
      .vcard-name { font-size: 22px; font-weight: 800; color: #0A0A0A; }
      .vcard-title { font-size: 14px; color: #525252; margin-top: 2px; }
      .vcard-company { font-size: 14px; color: #525252; }
      .vcard-summary { font-size: 13px; color: #525252; margin-top: 12px; line-height: 1.6; max-width: 320px; margin-left: auto; margin-right: auto; }
      .vcard-fields { margin-top: 20px; text-align: left; }
      .vcard-field { display: flex; align-items: center; gap: 12px; padding: 12px 0; border-bottom: 1px solid #FAFAF9; }
      ...
      .vcard-field-label { font-size: 11px; color: #737373; text-transform: uppercase; }
      .vcard-field-value { font-size: 14px; color: #262626; word-break: break-word; }
      .vcard-field-value a { color: #4F46E5; text-decoration: none; }
      .vcard-save-btn { display: block; width: 100%; padding: 14px; margin-top: 24px; background: #0A0A0A; color: #ffffff; border: none; border-radius: 10px; font-size: 16px; font-weight: 600; cursor: pointer; text-align: center; text-decoration: none; }
      .vcard-save-btn:hover { background: #262626; }
      .vcard-social { display: flex; justify-content: center; gap: 8px; margin-top: 16px; flex-wrap: wrap; }
      .vcard-social a { display: flex; align-items: center; justify-content: center; width: 40px; height: 40px; border-radius: 10px; background: #FAFAF9; color: #525252; text-decoration: none; font-size: 12px; font-weight: 700; }
      .vcard-social a:hover { background: #E5E5E5; }
    </style>
    ...
    <div class="vcard-fields">
      ...
      <a href="mailto:${esc(content['email'])}" style="text-decoration:none;">
        <div class="vcard-field">
          <div class="vcard-field-icon" style="background:#EEF2FF;">&#9993;</div>
      ...
      <a href="tel:${esc(content['phone'])}" style="text-decoration:none;">
        <div class="vcard-field">
          <div class="vcard-field-icon" style="background:#ECFDF5;">&#9742;</div>
      ...
      <a href="${esc(content['website'])}" target="_blank" rel="noopener" style="text-decoration:none;">
        <div class="vcard-field">
          <div class="vcard-field-icon" style="background:#FFFBEB;">&#127760;</div>
      ...
      ${hasAddress ? `
      <div class="vcard-field">
        <div class="vcard-field-icon" style="background:#F5F3FF;">&#128205;</div>
