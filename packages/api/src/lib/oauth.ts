...
// Apple's public JWKS endpoint for ID token verification.
...
export async function exchangeCodeForUser(
  ...
  // Audit-4 A4-H1: verify the JWT signature against Apple's JWKS before
  // trusting the claims. Apple mandates RS256 verification — without it,
  // a forged id_token could impersonate any user.
