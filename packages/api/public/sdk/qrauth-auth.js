...
(function (global) {
  ...
  QRAuth.prototype._showModal = function (session) {
    ...
    // QR image is rendered server-side and returned as a data: URL on the
    // session response — no third-party host, no client-side dependency.
    var qrImageUrl = session.qrImageDataUrl;
