      ...
      '/guide/': [
        {
          ...
          items: [
            ...
            { text: 'Sign in with QRAuth (OIDC)', link: '/guide/oidc' },
            { text: 'Sign in to Nextcloud', link: '/guide/nextcloud' },
      ...
      '/blog/': [
        {
          ...
          items: [
            ...
            { text: 'Sovereign sign-in for Nextcloud', link: '/blog/sovereign-nextcloud-login' },
          ],
        },
      ],
    },
