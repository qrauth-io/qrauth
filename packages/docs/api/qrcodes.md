...
QR codes are the core resource of QRAuth. Every code is ECDSA-P256 signed at creation time. The signature covers the destination URL, geo-hash, expiry, and a hash of the content payload, making cloning or tampering detectable at scan time.
