...
- **Cross-language vectors** — the canonical test vector suite runs via `npm test -w packages/protocol-tests` against the pinned fixtures; any drift fails the build.
